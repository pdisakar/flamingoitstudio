  ...
  return (
    <div className="container">
          ...
          <div className="page-title">
            ...
            <article className="text-xl [&>p]:mt-7 [&>p:first-child]:mt-0 mt-8 md:mt-12  lg:mt-16">
              ...
              <p>
                ...
                project we take on is an opportunity to redefine possibilities.
                From sleek websites to complex web applications, we combine
                clean code, intuitive interfaces, and scalable architecture to
                bring your digital vision to life.
              </p>
              <p>
                Join us on a journey where performance meets precision, where
                every line of code tells a story, and where your business goals
                fuel our development process. Welcome to Flamingo IT
                Studio—where we don’t just develop websites; we engineer digital
                experiences that move your brand forward.
              </p>
            </article>
          </div>
        </div>
      ...
      <div className="how-we-stand-out common-box pt-0">
        <ul className=" lg:[&>li>h3]:text-5xl md:[&>li>h3]:text-4xl [&>li>h3]:text-3xl [&>li>h3]:font-semibold [&>li>p]:text-xl lg:[&>li>p]:mt-6 md:[&>li>p]:mt-5 [&>li>p]:mt-4 lg:[&>li]:py-16 md:[&>li]:py-14 [&>li]:py-10 first:[&>li]:border-t [&>li]:border-b [&>li]:border-border/25">
          {how_we_stand_out.map(item => (
            <li
              key={item.id}
              className="">
